...
class nowPlaying(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        playphoto = ImageTk.PhotoImage(file = "play_button_dark.png")
        forwardphoto = ImageTk.PhotoImage(file = "forwardarrowdark.png")
        backwardphoto = ImageTk.PhotoImage(file = "backarrowdark.png")
        volupphoto = ImageTk.PhotoImage(file = "plus_dark.png")
        voldownphoto = ImageTk.PhotoImage(file = "minus_dark.png")
        
        self.secv = StringVar()
        self.minv = StringVar()
        self.lengthv = StringVar()
        
        self.configure(background = 'gray22')

        self.switchbutton = tk.Button(self, height = 130, width = 130, highlightthickness = 0, bd = 0, bg = 'gray22',
                            activebackground = 'gray22', relief = FLAT, command=lambda: controller.show_frame("songList"))
        self.switchbutton.place(relx=0.5, rely=0.24, anchor= CENTER)
        
        self.songTitle = Label(self, text = "Song Title", bg = 'gray22', font = ('Andale Mono', 10,"bold"), fg = 'white')
        self.songTitle.place(relx = 0.5, rely = 0.50, anchor = CENTER)
        
        self.artistName = Label(self, text = "Artist Name", bg = 'gray22', font = ('Andale Mono', 10), fg = 'white')
        self.artistName.place(relx = 0.5, rely = 0.56, anchor = CENTER)
        
        s = ttk.Style()
        s.theme_use('alt')
        s.configure("TProgressbar", foreground = '#A2D5AC', background = '#A2D5AC', troughcolor = 'white', thickness = 5, relief = RAISED, bd = 0, hilightthickness = 0)
        ...
        self.timerLabel = Label(self, textvariable = self.secv, bg = 'gray22', font = ('Andale Mono', 10), fg = 'white')
        self.timerLabel.place(relx = 0.09, rely = 0.64, anchor = CENTER)
        
        self.lengthLabel = Label(self, textvariable = self.lengthv, bg = 'gray22', font = ('Andale Mono', 10), fg = 'white')
        self.lengthLabel.place(relx = 0.91, rely = 0.64, anchor = CENTER)
        
        backwards = tk.Button(self, height = 70, width = 70, bg = 'gray22', activebackground = 'gray22', 
        ...
        play = tk.Button(self, height = 70, width = 70, bg = 'gray22', activebackground = 'gray22', 
                               highlightthickness = 0, bd = 0, command = self.playPress)
        play.place(relx=0.5, rely=0.81, anchor= CENTER)
        play.config(image = playphoto)
        play.image = playphoto
        
        forwards = tk.Button(self, height = 70, width = 70, bg = 'gray22', activebackground = 'gray22', 
                               highlightthickness = 0, bd = 0, command = self.forwardPress)
        forwards.place(relx=0.65, rely=0.82, anchor= CENTER)
        forwards.config(image = forwardphoto)
        forwards.image = forwardphoto
        
        volumeUp = tk.Button(self, height = 70, width = 70, bg = 'gray22', activebackground = 'gray22', 
                               highlightthickness = 0, bd = 0,)
        volumeUp.place(relx = 0.8, rely = 0.82, anchor = CENTER)
        volumeUp.config(image = volupphoto)
        volumeUp.image = volupphoto
        
        volumeDown = tk.Button(self, height = 70, width = 70, bg = 'gray22', activebackground = 'gray22', 
                               highlightthickness = 0, bd = 0,)
        volumeDown.place(relx = 0.20, rely = 0.82, anchor = CENTER)
